...
CREATE TABLE `discussion`  (
  ...
  `maxSeq` bigint(20) NULL DEFAULT NULL,
...
-- ----------------------------
INSERT INTO `discussion` VALUES (1, 'jforgame讨论组', 1000, '2024-11-09 11:17:48', 1858076564437708928);
...
-- ----------------------------
INSERT INTO `discussionmember` VALUES (1, 1000, 1, 'aa', '2024-11-02 11:19:00', 0, 1858076564437708927);
...
CREATE TABLE `friendapply`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1855244484024590338 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `message`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1858076564437708929 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Table structure for ossresource
-- ----------------------------
DROP TABLE IF EXISTS `ossresource`;
CREATE TABLE `ossresource`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  ...
  `originalName` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL,
  `md5` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL,
  `createdDate` datetime NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 207 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of ossresource
-- ----------------------------
...
CREATE TABLE `user`  (
  ...
  `chatMaxSeq` bigint(20) NULL DEFAULT NULL,
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES (1000, 'jforgame', '$apr1$1000$668/pMBPHtbCefk.Pm17X1', 1, '专业写bug一百年', NULL, NULL, 'http://192.168.0.121:9000/database/http://192.168.0.121:9000/database/picture/df42963d623349e485b3d012fa8032eb.jpg', 0);
